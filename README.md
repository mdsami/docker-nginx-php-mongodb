...
[![Docker Pulls](https://img.shields.io/docker/pulls/mdsami/docker-nginx-php-mongodb.svg)](https://hub.docker.com/r/mdsami/docker-nginx-php-mongodb/)
...
```bash
docker pull mdsami/docker-nginx-php-mongodb
```

or other versions (7.2, 7.1, 7.0, 5.6, 5.5, 5.4 or 5.3):

```bash
docker pull mdsami/docker-nginx-php-mongodb:5.4
```

Alternately you can build the image yourself.

```bash
git clone https://github.com/mdsami/docker-nginx-php-mongodb-mongodb.git
cd docker-nginx-php
...
```bash
docker run --name app -d -p 8080:80 mdsami/docker-nginx-php-mongodb
```
...
docker run --name app -d -p 8080:80 \
  ...
  mdsami/docker-nginx-php-mongodb
```
...
docker run --name db -d --net pg_net mdsami/docker-postgresql
```
...
```
FROM mdsami/docker-nginx-php-mongodb:5.6
...
docker run --name app -d -p 80:80 php-7.2
```
